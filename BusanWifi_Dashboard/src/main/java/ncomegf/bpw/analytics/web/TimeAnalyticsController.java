...
public class TimeAnalyticsController extends TrustedTicket {

	@Auth(isLogin = false)
	@RequestMapping(value = "/timeAnalytics.do")
	public String TimeAnalytics(DataSet param, ModelMap model) throws Exception {
		...
		return "bpw/analytics/timeAnalytics";
	}
