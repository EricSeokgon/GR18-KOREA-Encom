...
@Controller
@RequestMapping("/bpw/dashboard")
public class DashBoardController extends TrustedTicket {

	@Auth(isLogin = false)
	@RequestMapping(value = "/dashBoard.do")
	public String DashBoard(DataSet param, ModelMap model) throws Exception {
		...
		return "bpw/dashboard/dashBoard";
	}
