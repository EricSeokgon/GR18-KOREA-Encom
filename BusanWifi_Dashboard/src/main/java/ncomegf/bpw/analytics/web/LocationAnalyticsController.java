...
public class LocationAnalyticsController extends TrustedTicket {

	@Auth(isLogin = false)
	@RequestMapping(value = "/locationAnalytics.do")
	public String locationAnalytics(DataSet param, ModelMap model) throws Exception {
		...
		return "bpw/analytics/locationAnalytics";
	}
