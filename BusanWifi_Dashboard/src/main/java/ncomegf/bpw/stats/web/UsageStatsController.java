...
public class UsageStatsController extends TrustedTicket {

	@Auth(isLogin = false)
	@RequestMapping(value = "/usageStats.do")
	public String usageStats(DataSet param, ModelMap model) throws Exception {
