...
public class FootTrafficStatsController extends TrustedTicket {

	@Auth(isLogin = false)
	@RequestMapping(value = "/footTrafficStats.do")
	public String footTrafficStats(DataSet param, ModelMap model) throws Exception {
		...
		return "bpw/stats/footTrafficStats";
	}
